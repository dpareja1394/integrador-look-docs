    ...
    */
    ...
    public void saveArticulos(Articulos entity) throws Exception {
        try {
            ...
            if ((entity.getAutor() != null) &&
                    (Utilities.checkWordAndCheckWithlength(entity.getAutor(),
                        150) == false)) {
    ...
    public void deleteArticulos(Articulos entity) throws Exception {
        ...
        try {
            ...
            if (Utilities.validationsList(anexoses) == true) {
                throw new ZMessManager().new DeletingException("anexoses");
            }

            categoriasArticuloses = categoriasArticulosDAO.findByProperty("articulos.codigoArti",
                    entity.getCodigoArti());
            ...
            eventosArticuloses = eventosArticulosDAO.findByProperty("articulos.codigoArti",
                    entity.getCodigoArti());
    ...
    public List<ArticulosDTO> getDataArticulos() throws Exception {
        try {
            ...
            for (Articulos articulosTmp : articulos) {
                ArticulosDTO articulosDTO2 = new ArticulosDTO();

                articulosDTO2.setCodigoArti(articulosTmp.getCodigoArti());
                articulosDTO2.setAutor((articulosTmp.getAutor() != null)
                    ? articulosTmp.getAutor() : null);
                articulosDTO2.setDescripcion((articulosTmp.getDescripcion() != null)
                    ? articulosTmp.getDescripcion() : null);
                articulosDTO2.setEstadoRegistro((articulosTmp.getEstadoRegistro() != null)
                    ? articulosTmp.getEstadoRegistro() : null);
                articulosDTO2.setFechaCreacion(articulosTmp.getFechaCreacion());
                articulosDTO2.setFechaModifcacion(articulosTmp.getFechaModifcacion());
                articulosDTO2.setNombre((articulosTmp.getNombre() != null)
                    ? articulosTmp.getNombre() : null);
                articulosDTO2.setUsuCrea((articulosTmp.getUsuCrea() != null)
                    ? articulosTmp.getUsuCrea() : null);
                articulosDTO2.setUsuModifica((articulosTmp.getUsuModifica() != null)
                    ? articulosTmp.getUsuModifica() : null);
                articulosDTO2.setCodigoUsua_Usuarios((articulosTmp.getUsuarios()
                                                                  .getCodigoUsua() != null)
