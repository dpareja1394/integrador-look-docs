...
public class ArticulosLogic implements IArticulosLogic {
	...
	public void TransferFile(String server, String user, String pass,
		...
		if (user == null) {
			throw new Exception("El usuario está vacio o nulo");
		}
		...
		if (pass == null) {
			throw new Exception("La contraseña esta vacia o nula");
		}
	...
	public void saveArticulos(Articulos entity, String categoriaSelected, String pdfUrl) throws Exception {
		...
		try {
			...
			if (entity.getCodigoArti() == null) {
				throw new ZMessManager().new EmptyFieldException("Codigo del artículo");
			}
			...
			throw new Exception("UPS! Tuvimos un error. Intenta de nuevo");
		} finally {
		}
	}
	...
	public List<ArticulosDTO> getDataArticulos() throws Exception {
		try {
			...
			for (Articulos articulosTmp : articulos) {
				...
				articulosDTO2
						.setAutor((articulosTmp.getAutor() != null) ? articulosTmp
								.getAutor() : null);
				articulosDTO2
						.setDescripcion((articulosTmp.getDescripcion() != null) ? articulosTmp
								.getDescripcion() : null);
				articulosDTO2.setEstadoRegistro((articulosTmp
						.getEstadoRegistro() != null) ? articulosTmp
						.getEstadoRegistro() : null);
				articulosDTO2.setFechaCreacion(articulosTmp.getFechaCreacion());
				articulosDTO2.setFechaModifcacion(articulosTmp
						.getFechaModifcacion());
				articulosDTO2
						.setNombre((articulosTmp.getNombre() != null) ? articulosTmp
								.getNombre() : null);
				articulosDTO2
						.setUsuCrea((articulosTmp.getUsuCrea() != null) ? articulosTmp
								.getUsuCrea() : null);
				articulosDTO2
						.setUsuModifica((articulosTmp.getUsuModifica() != null) ? articulosTmp
								.getUsuModifica() : null);
				articulosDTO2.setCodigoUsua_Usuarios((articulosTmp
						.getUsuarios().getCodigoUsua() != null) ? articulosTmp
						.getUsuarios().getCodigoUsua() : null);
