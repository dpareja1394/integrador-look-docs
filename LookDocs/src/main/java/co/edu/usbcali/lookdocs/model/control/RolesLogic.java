...
public class RolesLogic implements IRolesLogic {
    ...
    */
    ...
    public void saveRoles(Roles entity) throws Exception {
        try {
            if (entity.getCodigoRol() == null) {
                throw new ZMessManager().new EmptyFieldException("codigoRol");
            }
            ...
            if (getRoles(entity.getCodigoRol()) != null) {
    ...
    public void deleteRoles(Roles entity) throws Exception {
        ...
        try {
            usuarioses = usuariosDAO.findByProperty("roles.codigoRol",
                    entity.getCodigoRol());
    ...
    public List<RolesDTO> getDataRoles() throws Exception {
        try {
            ...
            for (Roles rolesTmp : roles) {
                ...
                rolesDTO2.setCodigoRol(rolesTmp.getCodigoRol());
                rolesDTO2.setEstadoRegistro((rolesTmp.getEstadoRegistro() != null)
                    ? rolesTmp.getEstadoRegistro() : null);
                rolesDTO2.setFechaCreacion(rolesTmp.getFechaCreacion());
                rolesDTO2.setFechaModifcacion(rolesTmp.getFechaModifcacion());
                rolesDTO2.setNombreRol((rolesTmp.getNombreRol() != null)
                    ? rolesTmp.getNombreRol() : null);
                rolesDTO2.setUsuCrea((rolesTmp.getUsuCrea() != null)
                    ? rolesTmp.getUsuCrea() : null);
                rolesDTO2.setUsuModifica((rolesTmp.getUsuModifica() != null)
                    ? rolesTmp.getUsuModifica() : null);
    ...
    public Roles getRoles(Long codigoRol) throws Exception {
        ...
        try {
            entity = rolesDAO.findById(codigoRol);
        } catch (Exception e) {
