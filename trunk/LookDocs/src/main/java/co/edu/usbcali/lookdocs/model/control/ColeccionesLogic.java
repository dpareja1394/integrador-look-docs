...
*/
@Scope("singleton")
@Service("ColeccionesLogic")
public class ColeccionesLogic implements IColeccionesLogic {
    /**
    ...
    */
    ...
    public List<Colecciones> getColecciones() throws Exception {
        List<Colecciones> list = new ArrayList<Colecciones>();

        try {
            list = coleccionesDAO.findAll();
        } catch (Exception e) {
    ...
    public void deleteColecciones(Colecciones entity) throws Exception {
        ...
        try {
            coleccionesRsses = coleccionesRssDAO.findByProperty("colecciones.codigoCole",
                    entity.getCodigoCole());
    ...
    public List<ColeccionesDTO> getDataColecciones() throws Exception {
        try {
            List<Colecciones> colecciones = coleccionesDAO.findAll();

            List<ColeccionesDTO> coleccionesDTO = new ArrayList<ColeccionesDTO>();

            for (Colecciones coleccionesTmp : colecciones) {
                ColeccionesDTO coleccionesDTO2 = new ColeccionesDTO();

                coleccionesDTO2.setCodigoCole(coleccionesTmp.getCodigoCole());
                coleccionesDTO2.setNombre((coleccionesTmp.getNombre() != null)
                    ? coleccionesTmp.getNombre() : null);
                coleccionesDTO2.setCodigoUsua_Usuarios((coleccionesTmp.getUsuarios()
                                                                      .getCodigoUsua() != null)
                    ? coleccionesTmp.getUsuarios().getCodigoUsua() : null);
                coleccionesDTO.add(coleccionesDTO2);
            }
    ...
    public Colecciones getColecciones(Long codigoCole)
        throws Exception {
        Colecciones entity = null;

        try {
            entity = coleccionesDAO.findById(codigoCole);
        } catch (Exception e) {
            throw new ZMessManager().new FindingException("Colecciones");
        } finally {
        }
    ...
    public List<Colecciones> findPageColecciones(String sortColumnName,
        ...
        throws Exception {
        List<Colecciones> entity = null;

        try {
            entity = coleccionesDAO.findPage(sortColumnName, sortAscending,
                    startRow, maxResults);
        } catch (Exception e) {
            throw new ZMessManager().new FindingException("Colecciones Count");
        } finally {
        }
    ...
    * de busqueda voy a hacer.., ejemplo: where nombre=william o where nombre<>william,
    ...
    public List<Colecciones> findByCriteria(Object[] variables,
        ...
        try {
            list = coleccionesDAO.findByCriteria(where);
        } catch (Exception e) {
